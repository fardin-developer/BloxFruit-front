...
const Footer = () => {
  return (
    <footer className=" text-white px-4 py-10  border-t border-[#e4e4e414]">
          ...
          <div>
            ...
            <div className="text-xs text-[#F0F0F0] mt-4">
              <p className="mt-12 mb-6 ">
                ...
                <span className="bg-gradient-to-l to-[#FADA1B] from-[#FFF] bg-clip-text text-transparent">INOVATION INC.</span>
              </p>
              <p className="text-sm ">
